...
class RestaurantServiceTest {
    ...
    @Test
    public void calculate_order_value_should_return_correct_total_price() throws ItemNotFoundException {
        List<String> orderItems = Arrays.asList("Sweet corn soup", "Vegetable lasagne");
        int expectedOrderValue = 119 + 269;

        int actualOrderValue = restaurant.calculateOrderValue(orderItems);
